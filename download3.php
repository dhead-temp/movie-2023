...
<body>
    <script>
        const adblockRedirect = //locker-cpa.eu/adblock
    </script>
    <script type="application/javascript" src="https://locker-cpa.eu/ads.js"></script>
    <script type="text/javascript" id="cpljs-ecfc83c0-8315-11ed-89c9-9b914327d3d6" src="https://locker-cpa.eu/iframeLoader/ecfc83c0-8315-11ed-89c9-9b914327d3d6?"></script>
                ...
                <div class="sub-container">
                    ...
                    <div class="latest-movies-link">
                        ...
                        <div class="hero-note" style="text-align: center;">
                            <p><b>Pass Link Shorner</b><br><br> You have to pass link shorner On Next Page to download <?php echo $searchquery; ?></p>
                        </div>
                        <br>
                        <div class="movies-type-btns">
                            <a href="/file-locker.php" class="movie-type-link r-flex jut-sb ali-c" onclick="showLocker('ecfc83c0-8315-11ed-89c9-9b914327d3d6')">
