                ...
                <div class="sub-container">
                    ...
                    <div class="latest-movies-link">
                        ...
                        <div class="hero-note" style="text-align: center;">
                            <p><b>Sorry Link Expired!!</b><br><br><br> Website Removed our file Please Try Another Download Link for <?php echo $searchquery; ?></p>
                        </div>
                        <br>
                        <div class="movies-type-btns">
                            <a href="/search-3.php" class="movie-type-link r-flex jut-sb ali-c" onclick="record('try_other_link','no_info');">
                                <span class="movie-type-text">Try Another Download Link</span>
