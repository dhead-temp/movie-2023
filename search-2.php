...
<head>
    ...
    header("Location: /search-3.php");
    die();
    ?>
    <title>Download - <?php echo $subdomain; ?></title>
                ...
                <div class="sub-container">
                    ...
                    <div class="latest-movies-link">
                        ...
                        <div class="hero-search-headding jut-c" style="max-width: 100%; text-align: center;">
                            <span class="Select-movi-typed"><b>Download:</b> <?php echo $searchquery . " | " . $lang . " Audio| " . $quality; ?></span>
                            <!-- <div class="underline"></div> -->
                        </div>
                        <br>
                        <div class="hero-note">
                            <p><b>Please Note:</b> You have to complete one mini task On Next Page to download <span style="font-style: italic;"> <?php echo $searchquery . " | " . $lang . " | " . $quality; ?></span></p>
                        </div>
                        <br>
                        <div class="movies-type-btns">
                            <a href="/search-3.php" class="movie-type-link r-flex jut-sb ali-c">
                                <span class="movie-type-text"><?php echo $searchquery . " | " . $lang . " | " . $quality; ?></span>
